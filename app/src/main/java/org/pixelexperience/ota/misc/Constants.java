...
public final class Constants {
    ...
    static final String OTA_URL = "https://gitlab.com/androidsantoni/ota/pixelexperience/-/raw/%s/%s";
    static final String OTA_CI_URL = "https://gitlab.com/androidsantoni/ota/pixelexperience/-/raw/%s/%s";
    static final String MAINTAINER_URL = "https://t.me/omansh_krishn";
    static final String DOWNLOAD_WEBPAGE_URL = "https://gitlab.com/androidsantoni/ota/pixelexperience/-/raw/%s/changelog/%s";
